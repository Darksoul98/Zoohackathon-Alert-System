...
def sms():
    ...
    boolean=False
    if message_body.lower()=='wildlifesosalert' or  message_body.lower()=='wildlifesos alert':
        ...
        resp.message('Invalid input! Please send WILDLIFESOS if you would like to report any incident.')
...
def welcome():
    ...
    resp = VoiceResponse()
    resp.say("Welcome to Wildlife SOS")
